...
py -3.7 pytorch/realtime_inference.py \
    --model_type=Cnn14 \
    --checkpoint_path=Cnn14_mAP=0.431.pth

py -3.7 pytorch/inference.py sound_event_detection \
    --model_type=Cnn14_DecisionLevelMax \
    --checkpoint_path=Cnn14_DecisionLevelMax_mAP=0.385.pth \
    --audio_path=resources/R9_ZSCveAHg_7s.wav
...
python openwakeword_realtime.py --model_path shiv_aak_aash.onnx --display_name "Shiv Akash" --wakeword_name "shiv_aak_aash"

py -3.7 pytorch\realtime_inference.py --model_type=Cnn14 --checkpoint_path=Cnn14_mAP=0.431.pth

python pytorch/realtime_inference.py --checkpoint_path Cnn14_mAP=0.431.pth --anc --play_audio
