...
# Ensure piper-sample-generator is in sys.path and generate_samples is imported
# This part was moved outside the `if` block to ensure it always runs.
if "piper-sample-generator/" not in sys.path:
    sys.path.append("piper-sample-generator/")

from generate_samples import generate_samples

target_word = 'shiv_aak_aash' # @param {type:"string"}
